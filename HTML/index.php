...
<span class="sr-only">Obrir el men&uacute; principal</span>
<i class="fa-solid fa-bars" aria-hidden="true"></i>
</button>

<img src="logo.png" alt="Logo Explotaci&oacute;">
<div class="hero-copy">
<h1>Gesti&oacute; de l&#039;Explotaci&oacute; Fruiteres</h1>
...
<?php else: ?>
<a class="login-cta" href="login.html">Inicia sessi&oacute;</a>
<?php endif; ?>
</div>
...
<button class="sidebar-close" type="button" aria-label="Tancar el men&uacute;" onclick="document.getElementById('menuToggle').click()">
...
<span class="menu-title"><span class="menu-icon">&#x1F4CC;</span><span class="menu-label">Gesti&oacute; de cultius</span></span>
<i class="fa-solid fa-chevron-down" aria-hidden="true"></i>
</button>
<div class="menu-section-body">
<button onclick="openPage('../PHP/consulta_parcela_sector.php')" data-url="../PHP/consulta_parcela_sector.php">Parcel&middot;les i sectors</button>
...
<button onclick="openPage('../PHP/comparativa_varietats.php')" data-url="../PHP/comparativa_varietats.php">Comparacio Parcel&middot;les i Varietats</button>
<button onclick="openPage('../PHP/infraestructura.php')" data-url="../PHP/infraestructura.php">Infraestructura</button>
<button onclick="openPage('plantacio.php')" data-url="plantacio.php">Plantaci&oacute;</button>
<button onclick="openPage('fila.php')" data-url="fila.php">Files</button>
<button onclick="openPage('previsio_collita.php')" data-url="previsio_collita.php">Previsi&oacute; de collita</button>
</div>
</div>
...
<button onclick="openPage('aplicacio.php')" data-url="aplicacio.php">Nova aplicaci&oacute;</button>
...
<button onclick="openPage('lot_produccio.html')" data-url="lot_produccio.html">Lot de producci&oacute;</button>
<button onclick="openPage('control_qualitat.php')" data-url="control_qualitat.php">Nou control de qualitat</button>
<button onclick="openPage('estat_fenologic.html')" data-url="estat_fenologic.html">Nou estat fenol&ograve;gic</button>
<button onclick="openPage('../PHP/mapa_calor_parceles.php')" data-url="../PHP/mapa_calor_parceles.php">Mapa de calor</button>
<div class="menu-subheader">Detall t&egrave;cnic</div>
<button onclick="openPage('aplicacio_productes.php')" data-url="aplicacio_productes.php">Aplicaci&oacute; de productes</button>
...
<button onclick="openPage('maquinaria.html')" data-url="maquinaria.html">Maquin&agrave;ria</button>
<button onclick="openPage('contracte.php')" data-url="contracte.php">Contractes</button>
<button onclick="openPage('absencia.php')" data-url="absencia.php">Abs&egrave;ncies</button>
<button onclick="openPage('documentacio.html')" data-url="documentacio.html">Documentaci&oacute;</button>
...
<button onclick="openPage('../PHP/calendari_mensual.php')" data-url="../PHP/calendari_mensual.php">&#x1F4C5; Vista calendari</button>
<button onclick="openPage('../PHP/calendari_absencies.php')" data-url="../PHP/calendari_absencies.php">&#x1F4C5; Vista calendari</button>
<button onclick="openPage('../PHP/llista_jornades.php')" data-url="../PHP/llista_jornades.php">&#x1F4CA; Resum hores treballades</button>
</div>
</div>

<div class="menu-section">
<button class="menu-section-header">
&#x2699;&#xFE0F; Configuraci&oacute; <i class="fa-solid fa-chevron-down"></i>
</button>
<div class="menu-section-body">
