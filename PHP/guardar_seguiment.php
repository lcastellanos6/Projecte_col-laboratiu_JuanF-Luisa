...
$estimacio = !empty($_POST['estimacio_actualizada_collita']) ? floatval($_POST['estimacio_actualizada_collita']) : null;
...
// Preparar la inserció
$sql = "INSERT INTO Seguiment 
    (id_sector, data_registre, estat_fenologic, creixement_vegetatiu, incidencies_detectades, intervencions_realitzades, estimacio_actualizada_collita)
    VALUES (?, ?, ?, ?, ?, ?, ?)";
